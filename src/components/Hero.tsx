      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-zinc-600 light:text-zinc-300 font-light font-sans">
              |
            </span>{" "}
            MERN Developer
          </motion.h2>
          ...
          >
            ...
            applications using the MERN Stack. Passionate about writing clean
            code and creating beautiful interactive user experiences.
          </motion.p>
          ...
          <motion.div
            ...
            id="hero-socials"
          >
            <span className="text-xs font-mono tracking-widest text-[#52525B] uppercase mr-2">
              Connect:
            </span>
            <a
